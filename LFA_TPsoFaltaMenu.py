...
class AutomatoFD:
    ...
    def minimizaAfd(self):
        mat_equivalentes = self.__testa_equivalencia()
...
def automatosEquivalentes(automato1, automato2, cadeia):
    ...
    mat = []
    matriz = automato_concatenado.__testa_equivalencia()
    palavra = cadeia
    automato1.limpaAfd()
    automato2.limpaAfd()
...
def Menu():
    ...
    if operacao == 0:
        ...
        print("0-voltar")
        print("1-Salvar o AFD")
        print("2-Carregar o AFD")
        print("3-Cria copia do AFD")
        ...
        print("0-voltar")
        print("4-Testar os estados de equivalencia do AFD")
        print("5-Testar equivalencia entre 2 AFD fornecidos")
        print("6-Calcular o automato minimizado")
        op = int(input("Qual operação deseja fazer?:"))
        if op == 0:
            Menu()
    elif operacao == 3:
        ...
        print("0-voltar")
        print("7-operação com conjuntos")
        op = int(input("Qual operação deseja fazer?:"))
        if op == 0:
            Menu()
    else:
...
if __name__ == '__main__':
    ...
    print("Automato 2:\n", afdSecundario)
    Menu()
    # mat = afdSecundario.__testa_equivalencia()
    ...
    # ------------------------------------------------
    print('-----------------------------------------------\\-----------------------------------------------')
    # concatenado = automatosEquivalentes(afd, afdSecundario, cadeia)
    # print(concatenado)
    # print('-----------------------------------------------\\-----------------------------------------------')
